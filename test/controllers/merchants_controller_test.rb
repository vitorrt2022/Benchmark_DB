...
class MerchantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create merchant" do
    assert_difference("Merchant.count") do
      post merchants_url, params: { merchant: { legal_representative_name: @merchant.legal_representative_name, user_id: @merchant.user_id } }
    end
  ...
  test "should update merchant" do
    patch merchant_url(@merchant), params: { merchant: { legal_representative_name: @merchant.legal_representative_name, user_id: @merchant.user_id } }
